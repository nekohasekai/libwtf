...
type tunOptions struct {
	*tun.Options
	...
	httpProxyBypassDomain []string
	httpProxyMatchDomain  []string
}
...
func (o *tunOptions) GetDNSServerAddress() (*StringBox, error) {
	if len(o.DNSServers) > 0 {
		return wrapString(o.DNSServers[0].String()), nil
	}
